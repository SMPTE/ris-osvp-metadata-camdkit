...
specified duration. Each parameter is either: * static: the parameter has a
constant value over the duration of the clip * dynamic: the parameter is sampled
at regular intervals over the duration of the clip
...
if __name__ == "__main__":
  print(generate_documentation(sys.stdout))