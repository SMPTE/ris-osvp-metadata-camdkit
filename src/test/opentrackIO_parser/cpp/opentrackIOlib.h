...
public:
    ...
    void OTProtocol::Init(std::string msg_text, std::string schema_text, bool verbose); // Initailize objects
    ...
    double Get_sample_time(const std::string& part);                    // Time at which this sample was captured
