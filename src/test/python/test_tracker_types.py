...
CLASSIC_TRACKER_SCHEMA_PATH = Path("src/test/resources/classic/subschemas/static_tracker.json")
...
class TrackerTestCases(unittest.TestCase):
    ...
    def test_static_tracker_schemas_match(self):
        expected_schema: JsonSchemaValue = load_classic_camdkit_schema(Path("src/test/resources/classic/subschemas/static_tracker.json"))
